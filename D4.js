...
//     delete personaggio.height;
//     delete personaggio.birth_year;
//     delete personaggio.mass;
//     delete personaggio.skin_color;
//     delete personaggio.gender;
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  let mass = starWarsCharacters[i].mass;
  allmass.push(parseInt(mass));
}
let i = 0;
let masstot = 0;
...
// for (let i = 0; i < starWarsCharacters.length; i++) {
//   const robot = starWarsCharacters[i].hair_color;
